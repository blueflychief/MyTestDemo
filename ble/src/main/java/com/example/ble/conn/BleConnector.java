...
import com.example.ble.bluetooth.BleBluetooth;
...
import com.example.ble.utils.HexUtil;
...
public class BleConnector {
    ...
    public boolean enableCharacteristicNotify(BluetoothGattCharacteristic characteristic,
        ...
        if (characteristic != null
            ...
            KLog.w(TAG, "characteristic.getProperties():" + characteristic.getProperties());
    ...
    private boolean handleAfterInitialed(boolean initiated, BleCallback bleCallback) {
        if (bleCallback != null) {
            ...
            KLog.d(TAG, "initiated： " + initiated);
    ...
    public boolean setCharacteristicNotification(BluetoothGatt gatt,
        ...
        if (gatt == null || characteristic == null) {
            KLog.w(TAG, "gatt or characteristic equal null");
            return false;
        }

        int properties = characteristic.getProperties();
        if ((properties & BluetoothGattCharacteristic.PROPERTY_NOTIFY) == 0) {
            KLog.w(TAG, "Check characteristic property: false");
            return false;
        }

        boolean success = gatt.setCharacteristicNotification(characteristic, enable);
        KLog.d(TAG, "setCharacteristicNotification----" + enable + "----success： " + success
    ...
    public boolean setCharacteristicIndication(BluetoothGatt gatt,
        ...
        boolean success = gatt.setCharacteristicNotification(characteristic, enable);
        KLog.d(TAG, "setCharacteristicIndication----" + enable + "----success： " + success
                + '\n' + "characteristic.getUuid() :  " + characteristic.getUuid());
