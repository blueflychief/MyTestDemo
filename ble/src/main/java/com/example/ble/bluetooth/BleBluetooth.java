...
import com.example.ble.conn.BleConnector;
import com.example.ble.exception.BleException;
import com.example.ble.exception.ConnectException;
import com.example.ble.scan.NameScanCallback;
import com.example.ble.scan.PeriodScanCallback;
import com.example.ble.utils.BluetoothUtil;
...
public class BleBluetooth {
    ...
    private BleGattCallback coreGattCallback = new BleGattCallback() {
        ...
        public void onConnectFailure(BleException exception) {
            KLog.w(TAG, "coreGattCallback：onConnectFailure ");
        ...
        public void onConnectSuccess(BluetoothGatt gatt, int status) {
            KLog.w(TAG, "coreGattCallback：onConnectSuccess ");
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            KLog.w(TAG, "coreGattCallback：onConnectionStateChange "
                    + '\n' + "status: " + status
                    + '\n' + "newState: " + newState
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            KLog.w(TAG, "coreGattCallback：onServicesDiscovered ");
        ...
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            KLog.w(TAG, "coreGattCallback：onCharacteristicRead ");
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            KLog.w(TAG, "coreGattCallback：onCharacteristicWrite ");
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            KLog.w(TAG, "coreGattCallback：onCharacteristicChanged ");
        ...
        public void onDescriptorRead(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
            KLog.w(TAG, "coreGattCallback：onDescriptorRead ");
        ...
        public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
            KLog.w(TAG, "coreGattCallback：onDescriptorWrite ");
        ...
        public void onReliableWriteCompleted(BluetoothGatt gatt, int status) {
            KLog.w(TAG, "coreGattCallback：onReliableWriteCompleted ");
        ...
        public void onReadRemoteRssi(BluetoothGatt gatt, int rssi, int status) {
            KLog.w(TAG, "coreGattCallback：onReadRemoteRssi ");
