...
public class CBPageAdapter<T> extends PagerAdapter {
    private static final int CB_ITEM_TAG = Integer.MAX_VALUE;
    protected List<T> mDatas;
    protected CBViewHolderCreator holderCreator;
    //    private View.OnClickListener onItemClickListener;
    private boolean canLoop = true;
    private CBLoopViewPager viewPager;
    private final int MULTIPLE_COUNT = 30000;
...
//        if(onItemClickListener != null) view.setOnClickListener(onItemClickListener);
    ...
    public View getView(int position, View view, ViewGroup container) {
        ...
        if (view == null) {
            ...
            view.setTag(CB_ITEM_TAG, holder);
        } else {
            holder = (Holder<T>) view.getTag(CB_ITEM_TAG);
        }
