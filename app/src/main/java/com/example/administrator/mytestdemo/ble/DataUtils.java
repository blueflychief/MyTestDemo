...
public class DataUtils {
    ...
    //demo数据
    public static UserInfoEntity getTempUserInfo(){
        UserInfoEntity entity = new UserInfoEntity();

        entity.setAge((byte) 35);
        entity.setHeight((byte)179);
        entity.setPulse((byte)75);
        entity.setSex((byte)1);
        entity.setUser_id(01020304);
        entity.setWeight(200.8f);
...
//    public static byte[] intArrayToByteArray(byte n){
//        byte [] a = new byte[8];
//        for(int i=0;i<8;i++){
//            byte temp = 1<<i ;
//            a[i] = n & temp;
