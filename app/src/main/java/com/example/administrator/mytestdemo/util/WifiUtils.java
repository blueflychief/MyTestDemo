...
public class WifiUtils {
     ...
     */
    public static void checkIsCurrentWifiHasPassword(Context context) {
        try {
                    ...
                    for (WifiConfiguration configuration : wifiConfiguration) {
                        if (configuration != null && configuration.status == WifiConfiguration.Status.CURRENT) {
                            ...
                            if (!TextUtils.isEmpty(configuration.SSID)) {
                                ...
                                boolean isNeedPwd = (!configuration.allowedKeyManagement.get(WifiConfiguration.KeyMgmt.NONE));
                                Log.i(TAG, "------ssid:" + ssid + "---:" + isNeedPwd);
