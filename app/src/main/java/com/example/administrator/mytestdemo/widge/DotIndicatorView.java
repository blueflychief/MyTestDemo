...
public class DotIndicatorView extends View {
    ...
    private int mDotNormalRadius = 20;
    private int mDotSelectRadius = 25;
    ...
    public DotIndicatorView(Context context, AttributeSet attrs) {
        ...
        mDotMargin = a.getDimensionPixelSize(R.styleable.DotIndicatorView_dot_margin, mDotMargin);
        mDotNormalRadius = a.getDimensionPixelSize(R.styleable.DotIndicatorView_dot_normal_radius, mDotNormalRadius);
        mDotSelectRadius = a.getDimensionPixelSize(R.styleable.DotIndicatorView_dot_select_radius, mDotSelectRadius);
