...
import com.example.administrator.mytestdemo.util.ColorUtils;
...
public class CustomSwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        boolean kswClickable = true;
        int tintColor = Integer.MIN_VALUE;

        TypedArray ta = attrs == null ? null : getContext().obtainStyledAttributes(attrs, R.styleable.CustomSwitchButton);
        if (ta != null) {
            thumbDrawable = ta.getDrawable(R.styleable.CustomSwitchButton_kswThumbDrawable);
            thumbColor = ta.getColorStateList(R.styleable.CustomSwitchButton_kswThumbColor);
            margin = ta.getDimension(R.styleable.CustomSwitchButton_kswThumbMargin, margin);
            marginLeft = ta.getDimension(R.styleable.CustomSwitchButton_kswThumbMarginLeft, margin);
            marginRight = ta.getDimension(R.styleable.CustomSwitchButton_kswThumbMarginRight, margin);
            marginTop = ta.getDimension(R.styleable.CustomSwitchButton_kswThumbMarginTop, margin);
            marginBottom = ta.getDimension(R.styleable.CustomSwitchButton_kswThumbMarginBottom, margin);
            thumbWidth = ta.getDimension(R.styleable.CustomSwitchButton_kswThumbWidth, thumbWidth);
            thumbHeight = ta.getDimension(R.styleable.CustomSwitchButton_kswThumbHeight, thumbHeight);
            thumbRadius = ta.getDimension(R.styleable.CustomSwitchButton_kswThumbRadius, Math.min(thumbWidth, thumbHeight) / 2.f);
            backRadius = ta.getDimension(R.styleable.CustomSwitchButton_kswBackRadius, thumbRadius + density * 2f);
            backDrawable = ta.getDrawable(R.styleable.CustomSwitchButton_kswBackDrawable);
            backColor = ta.getColorStateList(R.styleable.CustomSwitchButton_kswBackColor);
            backMeasureRatio = ta.getFloat(R.styleable.CustomSwitchButton_kswBackMeasureRatio, backMeasureRatio);
            animationDuration = ta.getInteger(R.styleable.CustomSwitchButton_kswAnimationDuration, animationDuration);
            fadeBack = ta.getBoolean(R.styleable.CustomSwitchButton_kswFadeBack, true);
            kswClickable = ta.getBoolean(R.styleable.CustomSwitchButton_kswClickable, true);
            tintColor = ta.getColor(R.styleable.CustomSwitchButton_kswTintColor, tintColor);
            ta.recycle();
        }
        ...
        setSwitchClickable(kswClickable);
    ...
    public void setSwitchClickable(boolean clickable) {
        ...
        KLog.i("-----setSwitchClickable:" + clickable);
    }
    ...
    //getColorStateList在appcompat-v7:23.1.0才支持
