        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            switch (resultCode) {
                ...
                case DownloadService.RESULT_FAILED:
                    Log.i(TAG, "-----下载出错");
                    Toast.makeText(UpdateActivity.this, "文件下载出错", Toast.LENGTH_SHORT).show();
                    finish();
                    break;
...
//                DownloadService.startDownloadService((mUpdateBean.fileurl, null, mResultReceiver,true);
                DownloadService.startDownloadService(URL, "update1.apk", mResultReceiver, true);
                break;
