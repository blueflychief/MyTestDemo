package com.example.administrator.mytestdemo.videorecorder;
...
import com.example.administrator.mytestdemo.videorecorder.recorder.CameraHelper;
import com.example.administrator.mytestdemo.videorecorder.recorder.RecordCallback;
import com.example.administrator.mytestdemo.videorecorder.recorder.VideoRecorder;
...
public class NewRecordVideoActivity extends Activity implements View.OnTouchListener, RecordCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 初始化录像机
        mRecorder = new VideoRecorder(this, FileUtil.MEDIA_FILE_DIR, this);
